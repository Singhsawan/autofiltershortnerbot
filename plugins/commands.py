...
from info import CHANNELS, ADMINS, AUTH_CHANNEL, LOG_CHANNEL, PICS, BATCH_FILE_CAPTION, CUSTOM_FILE_CAPTION, PROTECT_CONTENT, CHNL_LNK, GRP_LNK, REQST_CHANNEL, SUPPORT_CHAT_ID, MAX_B_TN, VERIFY, SHORTLINK_API, SHORTLINK_URL, TUTORIAL, IS_TUTORIAL
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                         [
                          ...
                          InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/TeamHMT_Movies")
                         ]
                        ]
                    )
                )
        ...
        try:
            ...
            msg = await client.send_cached_media(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                     [
                      InlineKeyboardButton('Dᴏᴡɴʟᴏᴀᴅ 📥', url="https://t.me/Watch_onlineMovie_bot?start=True"),
                      InlineKeyboardButton('Sᴛʀᴇᴀᴍ 🖥', url="https://t.me/Watch_onlineMovie_bot?start=True")
                   ],[
